...
const Agendar = () => {
    ...
    const googleCalendarLink = "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Mis+XV+de+Renata&dates=20250316T213000Z/20250317T030000Z&details=Celebracion+de+mis+XV&location=Salon+Salamandra,+CDMX";
    const outlookCalendarLink = "https://outlook.live.com/calendar/0/deeplink/compose?subject=Mis+XV+de+Renata&body=Celebracion+de+mis+XV&location=Salon+Salamandra,+CDMX&startdt=2025-03-16T21:30:00&enddt=2025-03-17T03:00:00&path=/calendar/action/compose";
    const appleCalendarLink = "data:text/calendar;charset=utf8,BEGIN:VCALENDAR%0AVERSION:2.0%0ABEGIN:VEVENT%0ASUMMARY:Mis+XV+de+Renata%0ADESCRIPTION:Celebracion+de+mis+XV%0ALOCATION:Salon+Salamandra,+CDMX%0ADTSTART:20250316T213000Z%0ADTEND:20250317T030000Z%0AEND:VEVENT%0AEND:VCALENDAR";
  
    return (
      <section className="agendar">
        <h2 className="titulo-agendar">¡Que no se te olvide!</h2>
